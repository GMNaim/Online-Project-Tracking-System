...
class UserAdmin(admin.ModelAdmin):
    fields = (
        ...
        'is_superuser', 'is_staff', 'team_member', 'is_team_leader', 'notification_count')
    list_display = ('id', 'username', 'email', 'role', 'department', 'team_member', 'is_team_leader', 'notification_count')
    list_display_links = ('id', 'username',)
    list_editable = ('role', 'department', 'team_member', 'is_team_leader', 'notification_count')
    ordering = ('id',)
